...
REM 设置工作目录
cd /d C:\Users\zhuxiangbo\Desktop\project\analyse_information
...
REM 运行 RSS 拉取和分析
C:\Users\zhuxiangbo\anaconda3\python.exe analyzer\pipeline.py --rss >> shared\logs\scheduler.log 2>&1
